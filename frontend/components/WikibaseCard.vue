  ...
  <CdxCard class="flex h-full flex-col">
    <template #title>
      <div class="flex items-center gap-3">
        ...
        />
        <CdxIcon v-else :icon="cdxIconGlobe" size="20" />
        <a
      ...
      <div class="mt-3 flex flex-col gap-4">
        <div v-if="showTotals" class="border-t border-gray-200 pt-3">
          ...
          <div class="mb-2 inline-flex items-center gap-1 text-xs text-black">
            <CdxIcon v-if="isStale('quantity')" :icon="cdxIconAlert" :size="14" />
          ...
          <div class="grid grid-cols-2 gap-3">
            <div v-if="props.w.quantityObservations?.mostRecent?.totalItems">
              ...
              <div class="text-xl font-bold">{{ props.w.fmt(props.w.quantityObservations?.mostRecent?.totalItems) }}</div>
            </div>
            <div v-if="props.w.quantityObservations?.mostRecent?.totalProperties">
              <div class="text-xs uppercase">Properties</div>
              <div class="text-xl font-bold">{{ props.w.fmt(props.w.quantityObservations?.mostRecent?.totalProperties) }}</div>
            </div>
            <div v-if="props.w.quantityObservations?.mostRecent?.totalLexemes">
              <div class="text-xs uppercase">Lexemes</div>
              <div class="text-xl font-bold">{{ props.w.fmt(props.w.quantityObservations?.mostRecent?.totalLexemes) }}</div>
            </div>
            <div v-if="props.w.quantityObservations?.mostRecent?.totalTriples">
              <div class="text-xs uppercase">Triples</div>
              <div class="text-xl font-bold">{{ props.w.fmt(props.w.quantityObservations?.mostRecent?.totalTriples) }}</div>
            </div>
          </div>
        </div>
        ...
        <div v-if="showRc" class="border-t border-gray-200 pt-3">
          ...
          <p class="mb-2 inline-flex items-center gap-1 text-xs text-black">
            <CdxIcon v-if="isStale('rc')" :icon="cdxIconAlert" :size="14" />
          ...
          <div class="grid grid-cols-2 gap-3">
            <div v-if="props.w.recentChangesObservations?.mostRecent?.humanChangeCount">
              ...
              <div class="text-xl font-bold">{{ props.w.fmt(props.w.recentChangesObservations?.mostRecent?.humanChangeCount) }}</div>
            </div>
            <div v-if="props.w.recentChangesObservations?.mostRecent?.humanChangeUserCount">
              <div class="text-xs uppercase">Human users</div>
              <div class="text-xl font-bold">{{ props.w.fmt(props.w.recentChangesObservations?.mostRecent?.humanChangeUserCount) }}</div>
            </div>
            <div v-if="props.w.recentChangesObservations?.mostRecent?.botChangeCount">
              <div class="text-xs uppercase">Bot changes</div>
              <div class="text-xl font-bold">{{ props.w.fmt(props.w.recentChangesObservations?.mostRecent?.botChangeCount) }}</div>
            </div>
            <div v-if="props.w.recentChangesObservations?.mostRecent?.botChangeUserCount">
              <div class="text-xs uppercase">Bot users</div>
              <div class="text-xl font-bold">{{ props.w.fmt(props.w.recentChangesObservations?.mostRecent?.botChangeUserCount) }}</div>
            </div>
          </div>
        </div>
      </div>
