	...
	<CdxCard class="flex h-full flex-col">
		...
		<template #supporting-text>
			<div class="mt-3 flex flex-col gap-5">
				...
				<section
					v-if="!showTotals && !showRc"
					class="rounded-md border border-gray-200 bg-white p-3 text-sm text-gray-700"
				>
					No metrics available yet. This wikibase may be newly discovered or
					missing data.
				</section>
			</div>
