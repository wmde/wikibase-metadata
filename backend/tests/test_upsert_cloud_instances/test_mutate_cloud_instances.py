...
async def wikibase_list(db_session):
    ...
    wikibases = [
        {
            "wikibase_name": "Local Wikibase",
            "type": WikibaseType["SUITE"],
        },
        {
            "wikibase_name": "Another Wikibase",
            "type": WikibaseType["OTHER"],
        },
        {
            "wikibase_name": "Existing Cloud Wikibase",
            "type": WikibaseType["CLOUD"],
        },
    ]
