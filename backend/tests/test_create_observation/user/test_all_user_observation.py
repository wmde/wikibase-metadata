...
@pytest.fixture
async def three_wikibases_with_script_path_user(db_session):
...
@pytest.mark.asyncio
async def test_update_all_user_observations_fail(three_wikibases_with_script_path_user, mocker):
