...
@pytest.fixture
async def test_fixture(db_session, mocker, wikibase_fixture):
...
@pytest.fixture
async def wikibase_with_quantity_observation(db_session): # pylint: disable=unused-argument
...
async def test_wikibase_quantity_most_recent_observation_query(wikibase_with_quantity_observation):
