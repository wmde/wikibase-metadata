...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("human_change_count", sa.Integer(), nullable=True),
        sa.Column("human_change_user_count", sa.Integer(), nullable=True),
        sa.Column("bot_change_count", sa.Integer(), nullable=True),
        sa.Column("bot_change_user_count", sa.Integer(), nullable=True),
